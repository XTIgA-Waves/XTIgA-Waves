function solution = solveWaveSTstabZank(problemData,methodData,varargin)
...
clear nquad quadRule geometryT qn qw;
...
clear geometryS qn qw quadRule zetaS zetaT rknotsT;
